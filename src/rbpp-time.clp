...
(defrule calc-mach-time-drilling
	 (part (material ?mat) )
	 ?op <- (operation (feature ?f1) (machine ?m1) (tool ?t1) (process drilling) (op-time -1.0) ) ; dns removed nil and added -1.0 - 061224
...
(defrule calc-mach-time-boring
	 (part (material ?mat) )
	 ?op <- (operation (feature ?f1) (machine ?m1) (tool ?t1) (process boring) (op-time -1.0) ) ; dns removed nil and added -1.0 - 061224
	 (machine (name ?m1) (speed-efficiency ?eff) )
	 (feature (name ?f1) (dim1 ?diam) (dim2 ?length) ) 
	 (tool (name ?t1) (material ?tmat) (diameter ?tdia) )
...
(defrule calc-mach-time-end-milling-slotting-hole
	(part (material ?mat) )
	?op <- (operation (feature ?f1) (machine ?m1) (tool ?t1) (process end-milling-slotting) (op-time -1.0) ) ; dns removed nil and added -1.0 - 061224
	(machine (name ?m1) (speed-efficiency ?eff) )
	(feature (name ?f1) (dim1 ?diam) (dim2 ?length) )
...
(defrule calc-mach-time-reaming
	?p <- (part (material ?mat) )
	?op <- (operation (feature ?f1) (machine ?m1) (tool ?t1) (process reaming) (op-time -1.0) ) ; dns removed nil and added -1.0 - 061224 )
	(machine (name ?m1) (speed-efficiency ?eff) ) 
	(feature (name ?f1) (dim1 ?diam) (dim2 ?length) ) 
	(tool (name ?t1) (material ?tmat) (diameter ?tdia) ) 
...
(defrule calc-mach-time-face-milling
	(part (material ?mat) )
	?op <- (operation (feature ?f1) (machine ?m1) (tool ?t1) (process face-milling) (op-time -1.0) ) ; dns removed nil and added -1.0 - 061224
	(machine (name ?m1) (speed-efficiency ?eff) )
...
(defrule calc-mach-time-side-milling
	(part (material ?mat) )
	?op <- (operation (feature ?f1) (machine ?m1) (tool ?t1) (process side-milling) (op-time -1.0) ) ; dns removed nil and added -1.0
	(machine (name ?m1) (speed-efficiency ?eff) )
...
(defrule calc-mach-time-slab-milling
	(part (material ?mat) )
	?op <- (operation (feature ?f1) (machine ?m1) (tool ?t1) (process slab-milling) (op-time -1.0) ) ; dns removed nil and added -1.0 - 061224
	(machine (name ?m1) (speed-efficiency ?eff) )
	(feature (name ?f1) (dim1 ?length) (dim2 ?fwidth) )
	(tool (name ?t1) (material ?tmat) (diameter ?tdia) (number-of-teeth ?nteeth) (width ?twidth) )
...
(defrule calc-mach-time-end-milling-peripheral
	?op <- (operation (feature ?f1) (machine ?m1) (tool ?t1) (process end-milling-peripheral) (op-time -1.0) ) ; dns removed nil and added -1.0 - 061224
	(machine (name ?m1) (speed-efficiency ?eff) )
	(feature (name ?f1) (dim1 ?length) )
	(tool (name ?t1) (material ?tmat) (diameter ?tdia) (number-of-teeth ?nteeth) )
    ...
    (printout t "printing DNS"   ?length ?tdia ?speed ?feed ?eff ?nteeth)          
    )
