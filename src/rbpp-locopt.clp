...
(defrule loc-opt-cost
	...
	(not (operation (feature ?f1) (rank ~nil) (machine ~nil) (cum-cost nil) ) )
	(not (operation (feature ?f1) (rank ~nil ) (cum-cost ?c&:(< ?c ?cucost) ) ))
	=>
